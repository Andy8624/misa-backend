...
export class CreateAssetWriteOffDto {
  @ApiProperty({
    description: 'Reason for the asset write-off.',
    example: 'Tài sản hư hỏng không thể phục hồi',
    required: false,
  })
  @Expose()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Date when the write-off transaction was posted (ISO 8601).',
  ...
  @ApiProperty({
    description: 'Date of the write-off voucher (ISO 8601).',
    example: '2025-06-29T09:30:00.000Z',
    type: 'string',
    format: 'date-time',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Unique number for the asset write-off voucher.',
    example: 'GHI-GIAM-001-2025',
    required: false,
  })
  @Expose()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'ID of the company associated with the asset write-off.',
  ...
  @ApiProperty({
    description:
      'Original file name for the Base64 attachment (e.g., writeoff_report.pdf).',
    example: 'asset_write_off_documentation.pdf',
    required: false,
  })
  @Expose()
  @IsOptional()
